...
{{--                </div>--}}
    ...
    <header class="bg-white shadow">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
            ...
            {{--<a href="/jobs/create" class="relative inline-flex items-center px-3 py-3 -ml-px text-sm font-medium text-white bg-gray-600 border border-gray-300 rounded-md leading-5 hover:text-white hover:bg-indigo-600 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-indigo-800 active:text-white transition ease-in-out duration-150 dark:bg-gray-800 dark:border-gray-600 dark:active:bg-indigo-600 dark:focus:border-blue-900">Create Job</a>--}}
        </div>
    </header>
